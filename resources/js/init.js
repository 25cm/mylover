...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: 'resources/css/style.css', containers: 1440 },
			'wide': { range: '-1920', href: 'resources/css/style-wide.css', containers: 1360 },
			'normal': { range: '-1680', href: 'resources/css/style-normal.css', containers: 1200 },
			'narrow': { range: '-1280', href: 'resources/css/style-narrow.css', containers: 960, lockViewport: true },
			'narrower': { range: '-1000', href: 'resources/css/style-narrower.css', containers: '95%' },
			'mobile': { range: '-640', href: 'resources/css/style-mobile.css', grid: { gutters: 20 } },
